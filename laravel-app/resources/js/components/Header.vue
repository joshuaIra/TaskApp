      ...
      <div class="flex justify-between items-center h-16">
        ...
        <div class="flex items-center space-x-2 sm:space-x-4 min-w-0">
          ...
          <router-link to="/" class="text-xl sm:text-2xl font-bold flex items-center space-x-2 sm:space-x-3 group min-w-0">
            ...
            <span class="text-white font-bold truncate">TaskApp</span>
          </router-link>
        </div>
        ...
        <div class="flex items-center space-x-2 sm:space-x-3">
          <router-link
            to="/profile"
            class="hidden lg:inline-flex px-3 py-2 rounded-lg text-white/95 hover:bg-white/20 transition-all duration-200"
          >
            Profile
          </router-link>
          ...
          <div class="relative">
            <button
              ...
              class="flex items-center space-x-2 sm:space-x-3 pl-2 sm:pl-4 border-l border-white/30 hover:bg-white/20 transition-all duration-200 rounded-lg pr-2 py-1"
            >
              <img 
