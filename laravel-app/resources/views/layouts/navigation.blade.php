                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        @forelse($recentNotifs as $notif)
                            <div class="px-4 py-2 text-sm text-gray-700 {{ is_null($notif->read_at) ? 'font-bold' : '' }}">
                        ...
                        @if($unread)
                            <div class="border-t">
                                ...
                                @csrf
                                <button type="submit" class="block w-full text-left px-4 py-2 text-sm text-blue-600">Mark all as read</button>
                            </form>
                            </div>
                        @endif
                    </x-slot>
