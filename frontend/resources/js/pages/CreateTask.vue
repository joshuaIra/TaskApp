              ...
              <div class="flex flex-wrap gap-2">
                ...
                >
                  <span class="flex items-center">
                    <svg v-if="form.tags.includes(tag)" class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
...
const availableTags = ['frontend', 'backend', 'design', 'urgent', 'bug', 'feature', 'documentation'];
